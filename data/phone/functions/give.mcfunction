give @s written_book{pages:[\
      '["",\
         {"text":"          "},\
         {"text":" ̧_̧_̧","color":"#573715","clickEvent":{"action":"change_page","value":3}, "hoverEvent":{"action":"show_text","contents":"Contacts"}},\
         {"text":"\\n "},\
         {"text":"✆Taxi","bold":false,"color":"gold","clickEvent":{"action":"change_page","value":4}, "hoverEvent":{"action":"show_text","contents":["Call ",{"text":"Hit & Run","italic"=true}," Taxis"]}},\
         {"text":"   "},\
         {"text":"ǁ☳|☲ǁ","bold":false,"color":"#573715","clickEvent":{"action":"change_page","value":3}, "hoverEvent":{"action":"show_text","contents":"Contacts"}},\
         {"text":"    "},\
